...
fun CalculatoraScreen(){
    ...
    Column(Modifier.padding(15.dp)) {
        TextField(
            ...
            label = { Text(text = "Insira o 1º valor:")},
        ...
        TextField(
            ...
            label = { Text(text = "Insira o 2º valor:")},
            keyboardOptions = KeyboardOptions.Default.copy(
                keyboardType = KeyboardType.Number
            ),
            modifier = Modifier.fillMaxWidth()
        ...
        Row(
            ...
            Button(onClick = {operator = "+"}, modifier = Modifier.padding(5.dp), colors = ButtonDefaults.buttonColors(backgroundColor = Cyan)){
                Text(text = "+")
            }
            Button(onClick = { operator = "-"}, modifier = Modifier.padding(5.dp), colors = ButtonDefaults.buttonColors(backgroundColor = Cyan)){
                Text(text = "-")
        ...
        Row(
            ...
            Button(modifier = Modifier.padding(5.dp), colors = ButtonDefaults.buttonColors(backgroundColor = Cyan),onClick = {
                value1 = ""
                value2 = ""
                operator = ""
                result = ""
